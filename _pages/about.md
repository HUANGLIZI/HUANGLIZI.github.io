...
My research focuses on the Multimodal Large Language Model including the vision-language model and medical image analysis. I am committed to helping doctors or researchers carry out quantitative analysis and treatment planning for tissues and organs of the human body by combining AI with medical images. I am currently a member of the [MIDRC/CRP-12](https://www.midrc.org/midrc-collaborating-research-projects/project-one-crp12) project, dedicated to determining medical image data quality, provenance, and harmonization.
...
* <span class='emoji'>🔥</span> [July 2023] One paper [NeRCo](https://arxiv.org/abs/2303.11722) is accepted by [ICCV 2023](https://iccv2023.thecvf.com/).
