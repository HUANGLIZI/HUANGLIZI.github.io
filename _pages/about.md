...
My research focuses on the Foundation Model including the multimodal large language model and Large-scale Data Harmonization. I am committed to helping doctors or researchers carry out quantitative analysis and treatment planning for tissues and organs of the human body by combining AI with medical images. I am currently a member of the [AAPM-MIDRC](https://www.aapm.org/org/structure/default.asp?committee_code=MIDRC) subcommittee and [MIDRC/CRP-12](https://www.midrc.org/midrc-collaborating-research-projects/project-one-crp12), dedicated to determining medical image data quality, provenance, and harmonization.
...
* <span class='emoji'>🔥</span> [Nov 2025] Our work [SASNet](https://authors.elsevier.com/c/1m8Lh77nKsC8k) is accepted by [Pattern Recognition](https://www.sciencedirect.com/journal/pattern-recognition).
...
* <span class='emoji'>🔥</span> [Jan 2025] One abstract is accepted by SIIM 2025 as [Oral Presentation](https://annualmeeting.siim.org/wp-content/uploads/2025/04/Multi-stage-Multimodal-Deep-Learning-Zihan-Li.pdf).
