...
* [C3] Yuhan Wang\*, **Zihan Li\***, Han Liu, Simon Arberet, Martin Kraus, Yuyin Zhou, Florin-Cristian Ghesu, Dorin Comaniciu, Ali Kamen, Riqiang Gao. Any2Any 3D Diffusion Models with Knowledge Transfer: A Radiotherapy Planning Study. CVPR 2026. [Paper](https://arxiv.org/abs/2605.09622)
...
* [J2] **Zihan Li**, Dandan Shan, Yunxaing Li, Paul E. Kinahan, Qingqi Hong. Scale-aware adaptive supervised network with limited medical annotations. Pattern Recognition (2025). [Paper](https://authors.elsevier.com/c/1m8Lh77nKsC8k)
* [J3] Dandan Shan\*, **Zihan Li\***, Yunxiang Li, Qingde Li, Jie Tian, Qingqi Hong. STPNet: Scale-aware Text Prompt Network for Medical Image Segmentation. IEEE Transactions on Image Processing (2025). [Paper](https://arxiv.org/abs/2504.01561)
